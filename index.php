...
<head>
    ...
    <link rel="stylesheet" media="screen" href="css/modal_style.css">
    ...
    <div id="header">
        <div id="menu">
            ...
            <div id="cartBlock">
                ...
                <a href="/cart.html">
                    <img style="margin: 0 0 5px 5px;" src="images/cart.png" width="30" height="30">
                    <span id="cart"></span><span>₴</span>
                </a>
            </div>
			<a href="/hub.html">Видеокаталог</a>
